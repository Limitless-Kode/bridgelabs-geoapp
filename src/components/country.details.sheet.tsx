...
const CountryDetailsSheet = ({country, expand, toggle}: CountryDetailsSheetProps) => {
    return (
        <div
            ...
            className={`transition-all fixed ${expand ? "bottom-0" : "bottom-[calc(-80vh+75px)] md:bottom-[calc(-50vh+75px)]"} right-5 w-[90vw] md:min-w-[400px] rounded-t-xl overflow-clip max-h-[80vh] md:max-h-[50vh]`}
        >
